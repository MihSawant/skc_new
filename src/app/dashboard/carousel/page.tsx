   ...
   // const [url, setUrl] = useState('');
    ...
    function updateChangeImg(toUpdate: string, leader: object){
     ...
     function changeImage(event:any){
        ...
        const options = {
            method: 'POST',
            url: '/api/dashboard/carousel/addimage',
            headers: {
         ...
         return axios.request(options).then(resp => {
             const url = "/assets/img/carousel/"+resp.data.file;
             return "/assets/img/carousel/"+resp.data.file;
        })
            .catch(err => console.error(err));
    }
    ...
    async function updateLeader(aboutUsImage: object){
        ...
        axios.put("/api/dashboard/carousel/"+aboutUsImage._id, data, {
    ...
    return(
        <>
            <DashboardHeader title={"Carousel Images"}/>
